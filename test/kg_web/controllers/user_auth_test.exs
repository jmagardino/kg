defmodule KgWeb.UserAuthTest do
  use KgWeb.ConnCase, async: true

  alias Kg.Accounts
  alias KgWeb.UserAuth
  import Kg.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, KgWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      KgWeb.Endpoint.subscribe(live_socket_id)
