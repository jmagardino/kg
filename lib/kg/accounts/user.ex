defmodule Kg.Accounts.User do
  ...
  def registration_changeset(user, attrs) do
    user
    |> cast(attrs, [:email, :password, :first_name, :last_name, :address])
    |> validate_email()
    |> validate_password()
  end
  ...
  defp validate_email(changeset) do
    ...
    |> validate_format(:email, ~r/^[^\s]+@[^\s]+\.+[^\s]+$/, message: "Please enter a valid email")
  ...
  """
  def valid_password?(%Kg.Accounts.User{hashed_password: hashed_password}, password)
